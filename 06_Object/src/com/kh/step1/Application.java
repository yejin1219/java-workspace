...
public class Application {
	...
	/*
	 * 객체 : 실제로 존재하는 것
	 *       사물과 같은 유형적인 것뿐만 아니라, 개념이난 논리와 같은 무형적인 것도 포함
	 *       
	 * 객체 지향 프로그래밍(OPP, Objected-Oriented Programming)
	 * - 프로그램을 개발하는 기법으로 객체들을 만들고 이러한 객체들을 연결해서 프로그램을 완성하는 기법
	 * - 객체 지향 프로그래밍 특성을 지원하는 언어를 객체 지향 프로그래밍 언어라고 한다.
	 * - 코드의 재사용성이 높고, 유지보수가 용이하다.
	 * 
	 * 
	 * 객체 지향 프로그래밍의 특징(**기억하기**)
	 * 1. 추상화 : 객체들이 가진 공통의 특성들을 파악하고 불필요한 특성들을 제거하는 과정
	 * 2. 캡슐화 : 객체의 속성(필드)와 기능(메소드)을 하나로 묶고 실제 구현내용을 감추는 것
	...
	public static void main(String[] args) {
		...
		//객체 생성 = 메모리에 올라간다 = 객체의 구성요소가 다 올라간다(Field, Method)
		Tv tv = new Tv();
		...
		System.out.println("TV상태 : " + tv.channel); //20
		tv.channelUp();
		tv.channelUp();
		tv.channelUp();
		tv.channelDown();
