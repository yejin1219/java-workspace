...
//		b.method1();
	...
	public void method1() {
		...
		//자바 1.9 버전 이후로는 Boxing, UnBoxing기능을 안쓰도록
		//Deprecated 되어 있음 
	...
	public void method2() {
		...
		//1. 문자열을 기본 자료형으로 변경 : Wrapper클래스에서 제동하는 parseXXX()
		...
		// 2-1.문자열로 변경하는 또 다른 방법 : Wrapper 클래스에서 제공하는 valueOf().toString()메서드를 사용하는 방법
