...
//		a.method1();
	...
	public void method1() {
		...
		result = Arrays.stream(values).noneMatch(value -> value % 5 ==0); //조건을 모두 만족하지 않느냐? true(조건을 모두 만족하지 않으니깐)
		System.out.println(result);
	...
	public void method2() {
		...
		result = students.stream().filter(student -> student.getGender().equals("남자")).anyMatch(student -> (student.getEnglish() + student.getEnglish()) / 2 >=70);
